...
<div class="sbi-button-actions">
	<form action="#" method="post">
		<input type="submit" class="button button-primary" value="<?php esc_html_e( 'Update', 'simple-blueprint-installer' ); ?>">
	...
	<form action="#" method="post">
		<input type="submit" class="button button-secondary" value="<?php esc_html_e( 'Delete all plugins installed', 'simple-blueprint-installer' ); ?>">
	...
	<form action="#" method="post">
		<input type="submit" class="button button-secondary" value="<?php esc_html_e( 'Activate all plugins', 'simple-blueprint-installer' ); ?>">
